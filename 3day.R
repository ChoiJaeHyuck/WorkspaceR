...
# 조건에 맞는 행 과 열 추출( data frame만 가능 )
...
#
air <- read.csv( 'C:\\WorkspaceBigDaejeon\\WorkspaceR\\airquality.csv', 
                 header = T )
air2 <- read.csv( 'C:\\WorkspaceBigDaejeon\\WorkspaceR\\airquality.csv', 
                  header = F )
